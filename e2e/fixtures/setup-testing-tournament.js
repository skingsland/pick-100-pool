...
const TEAMS = {
    'UConn_1':     { id: 'UConn_1',     full_name: 'Connecticut',     seed: 1,  region: 'East',    conference: 'Big East',    is_eliminated: false, rounds: [null, 2, 3, 5, 9, 17, 33] },
    'Houston_2':   { id: 'Houston_2',   full_name: 'Houston',         seed: 2,  region: 'South',   conference: 'Big 12',      is_eliminated: false, rounds: [null, 3, 4, 6, 0, null, null] },
    'Purdue_3':    { id: 'Purdue_3',    full_name: 'Purdue',          seed: 1,  region: 'Midwest', conference: 'Big Ten',     is_eliminated: false, rounds: [null, 2, 3, 5, 9, 0, null] },
    'Duke_4':      { id: 'Duke_4',      full_name: 'Duke',            seed: 4,  region: 'East',    conference: 'ACC',         is_eliminated: true,  rounds: [null, 5, 6, 0, null, null, null] },
    'Marquette_5': { id: 'Marquette_5', full_name: 'Marquette',       seed: 2,  region: 'West',    conference: 'Big East',    is_eliminated: true,  rounds: [null, 3, 0, null, null, null, null] },
    'Auburn_6':    { id: 'Auburn_6',    full_name: 'Auburn',          seed: 4,  region: 'Midwest', conference: 'SEC',         is_eliminated: true,  rounds: [null, 5, 6, 0, null, null, null] },
    'Iowa_7':      { id: 'Iowa_7',      full_name: 'Iowa State',      seed: 5,  region: 'South',   conference: 'Big 12',      is_eliminated: true,  rounds: [null, 6, 7, 0, null, null, null] },
    ...
    'Creighton_9': { id: 'Creighton_9', full_name: 'Creighton',       seed: 3,  region: 'South',   conference: 'Big East',    is_eliminated: true,  rounds: [null, 4, 5, 0, null, null, null] },
    ...
    'NCST_11':     { id: 'NCST_11',     full_name: 'NC State',        seed: 11, region: 'East',    conference: 'ACC',         is_eliminated: false, rounds: [null, 12, 13, 15, 19, 0, null] },
...
function buildBrackets(testUserId) {
    return {
        [BRACKET_1_ID]: {
            ...
            totalPoints: 177,
            num_teams_remaining: 3,
            isNewOrUpdated: false,
            total_bracket_points_for_round: [null, 87, 41, 21, 28, 0, 0],
        },
        [BRACKET_2_ID]: {
            name: "Alice's Picks",
            ownerId: FAKE_USER_1,
            ...
            isNewOrUpdated: false,
            total_bracket_points_for_round: [null, 92, 42, 26, 37, 17, 0],
        },
        [BRACKET_3_ID]: {
            name: "Bob's Bracket",
            ownerId: FAKE_USER_2,
            ...
            num_teams_remaining: 3,
            isNewOrUpdated: false,
            total_bracket_points_for_round: [null, 80, 30, 15, 28, 0, 0],
        },
    };
}
